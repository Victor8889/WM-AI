...
public abstract class AbstractRegisterTypeStrategy {
    ...
    public abstract boolean sendCode(String identity);
    /**
     * 校验验证码是否通过
     *
     ...
     */
    public abstract void checkVerifyCode(String identity, String verifyCode,String inviteCode);
   public abstract boolean resetPassword(ForgetFrontUserForEmailRequest request);
    /**
     * 登录
     *
     ...
     * @return 登录成功后的信息
     */
    public abstract boolean password(String oldpass, String newpass);
    /**
     * 获取登录用户信息
     *
