...
public interface FrontUserService {
     ...
     * @return 是否成功
     */
    boolean sendCode(FrontUserRegisterTypeEnum frontUserRegisterTypeEnum,String identity);
     ...
     */
    void verifyCode(FrontUserRegisterTypeEnum frontUserRegisterTypeEnum, String email,String code, String inviteCode);

    boolean resetPassword(ForgetFrontUserForEmailRequest request);
    ...
    Boolean password(FrontUserRegisterTypeEnum registerType,String oldpass,String newpass);
}
