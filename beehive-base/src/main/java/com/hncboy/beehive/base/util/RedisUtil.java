...
public class RedisUtil {
    ...
    public static boolean hasKeyValue(String key, String value) {
        return STRING_REDIS_TEMPLATE.opsForHash().hasKey(key, value);
    }
    ...
    public static long delete(String key,String value) {
        return STRING_REDIS_TEMPLATE.opsForList().remove(key, 0, value);
    }
