...
@Slf4j
@Component
public class RunRelaxMjScheduler {// implements ApplicationRunner
    ...
    public void handler() {
        if(!CommonEnum.isMainRun)
            return;
        log.info("1、  run relax MJ thread start.");
            //while(true) {
                try {
    ...
    public void getRuntMj() throws IOException, ParseException {
        try {
            ...
            log.error("执行relax RuntMj出现错误。" + e.getMessage());
        }
    }
    ...
    public void createAnswerMessage(RoomMidjourneyMsgDO answerMessage) throws IOException {
        try {// 填充公共字段
            ...
            Request request = new Request.Builder()
                    .url(CommonEnum.mjRelaxApi.get(0).getBaseUrl() + "mj-relax/mj/submit/imagine")//https://api.duckagi.com/
                    .method("POST", body)
    ...
    public void blendMessage(RoomMidjourneyMsgDO answerMessage) throws IOException {
        ...
        try {
            ...
            // 创建任务并返回状态
            OkHttpClient client = new OkHttpClient().newBuilder()
                    .callTimeout(45, TimeUnit.SECONDS) // 设置调用超时时间为10秒
            ...
            if(MjMsgActionEnum.BLEND.getAction().equals(answerMessage.getAction())) {
                ...
                request = new Request.Builder()
                        .url(CommonEnum.mjRelaxApi.get(0).getBaseUrl() + "mj-relax/mj/submit/blend")//https://api.duckagi.com/
                        .method("POST", body)
                        .addHeader("Authorization", "Bearer " + CommonEnum.mjRelaxApi.get(0).getApiKey())//YOUR_API_KEY
                        .addHeader("User-Agent", "Apifox/1.0.0 (https://apifox.com)")
                        .addHeader("Content-Type", "application/json")
                ...
                client = new OkHttpClient().newBuilder()
                        .callTimeout(145, TimeUnit.SECONDS) // 设置调用超时时间为10秒
                        .connectTimeout(145, TimeUnit.SECONDS)
                        .build();
                body = RequestBody.create(fm.toJson(),mediaType);
                request = new Request.Builder()
                        .url(CommonEnum.mjRelaxApi.get(0).getBaseUrl() + "mj-relax/mj/insight-face/swap")//https://api.duckagi.com/
                        .method("POST", body)
                        .addHeader("Authorization", "Bearer " + CommonEnum.mjRelaxApi.get(0).getApiKey())//YOUR_API_KEY
                        .addHeader("User-Agent", "Apifox/1.0.0 (https://apifox.com)")
                        .addHeader("Content-Type", "application/json")
    ...
    public void processTask(RoomMidjourneyMsgDO answerMessage) throws IOException, ParseException {
        ...
        RequestBody body = RequestBody.create("",mediaType);
        Request request = new Request.Builder()
                .url(CommonEnum.mjRelaxApi.get(0).getBaseUrl() + "mj-relax/mj/task/"+answerMessage.getDuckId()+"/fetch")//https://api.duckagi.com/
                .get()
                .addHeader("Authorization", "Bearer "+ CommonEnum.mjRelaxApi.get(0).getApiKey())//YOUR_API_KEY
                .addHeader("User-Agent", "Apifox/1.0.0 (https://apifox.com)")
                .build();
    ...
    public void actionImg(RoomMidjourneyMsgDO answerMessage) throws IOException {
      try{
        ...
        OkHttpClient client = new OkHttpClient().newBuilder()
                .callTimeout(45, TimeUnit.SECONDS) // 设置调用超时时间为10秒
                .connectTimeout(45, TimeUnit.SECONDS) // 设置连接超时时间为10秒
                .build();
        MediaType mediaType = MediaType.parse("application/json");
        RequestBody body = RequestBody.create( json,mediaType);
        Request request = new Request.Builder()
                .url(CommonEnum.mjRelaxApi.get(0).getBaseUrl() + "mj-relax/mj/submit/change")
                .method("POST", body)
                .addHeader("Authorization", "Bearer "+ CommonEnum.mjRelaxApi.get(0).getApiKey())//YOUR_API_KEY
                .addHeader("User-Agent", "Apifox/1.0.0 (https://apifox.com)")
                .addHeader("Content-Type", "application/json")
    ...
    public void vpzImg(RoomMidjourneyMsgDO answerMessage) throws IOException {
        ...
        RequestBody body = RequestBody.create( json,mediaType);
        Request request = new Request.Builder()
                .url(CommonEnum.mjRelaxApi.get(0).getBaseUrl() + "mj-relax/mj/submit/action")
                .method("POST", body)
                .addHeader("Authorization", "Bearer "+ CommonEnum.mjRelaxApi.get(0).getApiKey())//YOUR_API_KEY
                .addHeader("User-Agent", "Apifox/1.0.0 (https://apifox.com)")
                .addHeader("Content-Type", "application/json")
    ...
    try{
        ...
        if(response.code() == 200) {
            ...
            if(code == 21){
                ...
                request = new Request.Builder()
                        .url(CommonEnum.mjRelaxApi.get(0).getBaseUrl() + "mj-relax/mj/submit/modal")
                        .method("POST", body)
                        .addHeader("Authorization", "Bearer "+ CommonEnum.mjRelaxApi.get(0).getApiKey())//YOUR_API_KEY
                        .addHeader("User-Agent", "Apifox/1.0.0 (https://apifox.com)")
                        .addHeader("Content-Type", "application/json")
