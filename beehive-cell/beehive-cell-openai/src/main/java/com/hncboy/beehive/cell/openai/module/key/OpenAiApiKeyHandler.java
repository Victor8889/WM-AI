...
public class OpenAiApiKeyHandler {
    ...
    public Pair<String, String> getChatApiKeyInfo(String originalApiKey, String originalBaseUrl, String apiKeyStrategyEnumCode, String modeName) {
        ...
        try {
            ...
            String useScene = CommonEnum.getProductByApiModel(modeName).getUseScene();
            OpenAiApiKeyDO apiKeyInfo = CommonEnum.getByUseScene(useScene);
     ...
     * @return ApiKey 信息
     */
    public Pair<String, String> getProductChatApiKeyInfo(String originalApiKey, String originalBaseUrl, String apiKeyStrategyEnumCode, String modeName) {
        // 有值就直接返回
        if (StrUtil.isNotBlank(originalApiKey)) {
            return new Pair<>(originalApiKey, originalBaseUrl);
        }
