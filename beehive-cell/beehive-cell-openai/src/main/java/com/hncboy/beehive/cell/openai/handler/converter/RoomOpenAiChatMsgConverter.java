...
public interface RoomOpenAiChatMsgConverter {
    ...
    @Mapping(target = "inversion", expression = "java(\"answer\".equalsIgnoreCase(roomOpenAiChatMsgDO.getMessageType().name()))")
    RoomOpenAiChatMsgVO entityToVO(RoomOpenAiChatMsgDO roomOpenAiChatMsgDO);
